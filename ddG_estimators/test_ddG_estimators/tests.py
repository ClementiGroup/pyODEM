...
def _reference_ddG_implementation(trajfile,topfile,stationary_distribution):
    ...
    pair_2_33_energy = compute_delta_H(r0=0.578442,factor=0.1,epsilon=1,distances=pair_2_33_distances)
    ...
    pair_1_28_delta_energy = compute_delta_H(r0=0.820535,factor=1,epsilon=1,distances=pair_1_28_distances)
    pair_1_30_delta_energy = compute_delta_H(r0=0.550463,factor=0,epsilon=1,distances=pair_1_30_distances)
    pair_1_32_delta_energy = compute_delta_H(r0=0.536207,factor=0.6666,epsilon=1,distances=pair_1_32_distances)
    pair_2_33_delta_energy = compute_delta_H(r0=0.578442,factor=0.1,epsilon=1,distances=pair_2_33_distances)
    ...
    dH_mutated_d_pair_1_28 = compute_dH_mutated(r0=0.820535,fraction=1,distances=pair_1_28_distances)
    dH_mutated_d_pair_1_30 = compute_dH_mutated(r0=0.550463,fraction=0,distances=pair_1_30_distances)
    dH_mutated_d_pair_1_32 = compute_dH_mutated(r0=0.536207,fraction=0.6666,distances=pair_1_32_distances)
    dH_mutated_d_pair_2_33 = compute_dH_mutated(r0=0.578442,fraction=0.1,distances=pair_2_33_distances)

    product_exp_dH_mutated_pair_1_28 = np.multiply(weighted_delta_Hamiltonian,dH_mutated_d_pair_1_28)
    product_exp_dH_mutated_pair_1_30 = np.multiply(weighted_delta_Hamiltonian,dH_mutated_d_pair_1_30)
    product_exp_dH_mutated_pair_1_32 = np.multiply(weighted_delta_Hamiltonian,dH_mutated_d_pair_1_32)
    ...
    d_unfolded_d_pair_1_30 = unfolded_state_product_average/unfolded_state_average - unfolded_state_dH0_average
    ...
    d_unfolded_d_pair_1_32 = unfolded_state_product_average/unfolded_state_average - unfolded_state_dH0_average
